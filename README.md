...
- Oracle Database version: Version 21.3.0.0.0
...
Task 2: Temporary PDB Creation and Deletion For this task, I created a temporary pluggable database to demonstrate the process of provisioning and removal.
...
- Published screenshots in screenshots/ folder.

Challenges Faced
During the assignment, I encountered difficulties accessing Oracle Enterprise Manager Express (OEM Express). 
Specifically: 
